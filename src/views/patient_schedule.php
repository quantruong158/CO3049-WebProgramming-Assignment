...
<main style="margin-top: 6rem;">
    <form action="controllers/make_appointment.php" method="POST" class='d-flex flex-column gap-2'>
        ...
        <button id="makeAppointmentBtn" disabled type="button" class="btn btn-lg btn-dark rounded-0 mx-2 mb-2" data-bs-toggle="modal" data-bs-target="#confirmModal">Make Appointment</button>
        <!-- Modal -->
        <div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5 fw-bold" id="modalLabel">Confirm to make this appointment?</h1>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-lg btn-dark rounded-0" value="Make Appointment" />
                    </div>
                </div>
            </div>
        </div>
